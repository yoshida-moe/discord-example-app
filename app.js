...
import { BattleApp, formatMention, JinrouApp } from "./discord-service.js";
...
app.post('/interactions', async function (req, res) {
  ...
  if (type === InteractionType.MESSAGE_COMPONENT) {
    ...
    if (mainId === 'jinrou') {
      ...
      if (subId === 'vote') {
        resBody = jinrouService.vote(values);
      }
    ...
    console.log(resBody.data.content, resBody.data.embeds, resBody.data.components);
    return res.send(resBody);
  }
});
